...
<div class="row">
    <div class="col-md-6 mx-auto mt-5">
        <div class="card card-body bg-light mt5">
            ...
            <h1>Edit a domain</h1>            
            <form action="<?php echo URLROOT ?>/domains/updateDomain/<?php echo $data['id']; ?>" method="post">               
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="otherDetails" rows="3" name="otherDetails" class="form-control   <?php echo(!empty($data['otherDetails_err'])) ? 'is-invalid' : ''; ?>"><?php echo $data['otherDetails']; ?></textarea>
